...
export default function LearnDashboard() {
  ...
  if (!course || !content) {
    return (
      <div className="min-h-screen light-mode bg-bg flex items-center justify-center">
        <CustomCursor />
  ...
  if (!authorized) {
    return (
      <div className="min-h-screen light-mode bg-bg flex items-center justify-center px-6">
        <CustomCursor />
  ...
  return (
    <div className="min-h-screen light-mode bg-bg">
      <CustomCursor />
      <ProgressMigration />
