...
export const copy: Record<Lang, CopyShape> = {
  en: {
    ...
    about: {
      ...
      qualHeader: "Why work with Kamesh Malhotra",
      quals: [
        ...
        "Knows Razorpay, UPI, EMI, GST — Indian payment + tax systems built in",
        "Based in Jammu (J&K) · Available 9am–11pm IST across all of India",
      ],
  ...
  hi: {
    ...
    about: {
      ...
      qualHeader: "Kamesh Malhotra के साथ क्यों काम करें",
      quals: [
        "JP से सीधा connection — हर तकनीकी निर्णय, कोई agency बीच में नहीं",
        "हिंदी मातृभाषा, अंग्रेज़ी फ्लूएंट — हर बातचीत आपकी भाषा में",
        "Razorpay, UPI, EMI, GST का गहरा ज्ञान — भारतीय payment और tax systems built-in",
        "जम्मू (J&K) में स्थित · पूरे भारत के लिए 9am–11pm IST उपलब्ध",
      ],
