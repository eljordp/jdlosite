...
export const copy: Record<Lang, CopyShape> = {
  en: {
    ...
    about: {
      ...
      qualHeader: "How Kamesh Malhotra works",
      quals: [
        "Honest — tells you straight if a tier doesn't fit, won't upsell features you don't need",
        "Patient — no tech jargon, explains every decision so you understand what you're paying for",
        "Available — replies on WhatsApp within 2 hours, 9am–11pm IST, every day",
        "Transparent — every cost upfront, every timeline in writing, no surprise bills",
        "Direct — no agency layers, no \"let me check with my team,\" straight from him to you",
      ],
  ...
  hi: {
    ...
    about: {
      ...
      qualHeader: "Kamesh Malhotra कैसे काम करते हैं",
      quals: [
        "ईमानदार — सीधा बता देंगे अगर tier आपके लिए नहीं है, ज़रूरत न हो वो features नहीं बेचेंगे",
        "धैर्यवान — कोई tech jargon नहीं, हर निर्णय explain करेंगे ताकि आप समझें आप किसका पैसा दे रहे हैं",
        "उपलब्ध — WhatsApp पर 2 घंटे में reply, हर दिन 9am–11pm IST",
        "पारदर्शी — हर cost पहले से written में, हर timeline upfront, कोई surprise bill नहीं",
        "सीधे बात — कोई agency drama नहीं, कोई \"मैं team से check करता हूँ\" नहीं, उनसे सीधे आप तक",
      ],
