...
const PROOF_ITEMS: ProofItem[] = [
  ...
  },
  {
    name: "Muddled by Mia",
    slug: "muddled-by-mia",
    cats: ["Website", "Restaurant"],
    headline: "Custom website for a cocktail and mixology brand.",
    stat: "Live brand site",
  },
  {
    name: "Vacaville Appliance",
    slug: "vacaville-appliance",
    cats: ["AI", "Service Business"],
    headline: "Connected website, lead intake, and operating workflows for a live service business.",
    stat: "57 June jobs",
  },
  {
    name: "OlyLife Ohana",
    ...
    headline: "Health and wellness product site with education and store flow.",
    stat: "E-commerce",
  },
  {
    name: "Pomaika'i Co",
...
export const copy: Record<Lang, CopyShape> = {
  en: {
    ...
    proof: {
      ...
      sub: "24 live projects verified — fashion brands, service businesses, e-commerce stores, AI tools. Click any project to see the full case study.",
      items: PROOF_ITEMS,
      seeAll: "See all 24 live projects",
    ...
    team: {
      ...
      jpRole: "JDLO · Founder",
      jpName: "JP — Builder",
      jpDesc: "Builds the entire system. 24 live projects verified. Clients in the US, Vegas, Hawaii, and now India. Every site is built personally — no outsourcing, no templates, no agency fluff.",
      jpLink: "See the work →",
      kameshRole: "JDLO India · Director",
      kameshName: "Kamesh Malhotra",
      kameshTitle: "Director · JDLO India",
      kameshLocation: "Jammu (J&K), India · 21",
      kameshDesc: "Runs JDLO India from Jammu. Handles every conversation from the first WhatsApp message to launch day, in Hindi or English. Direct line to JP for every build.",
      kameshLangs: "Hindi (native) · English (fluent)",
      kameshEmail: "malhotrakamesh7@gmail.com",
      kameshCta: "Message Kamesh Malhotra",
    },
    roadmap: {
    ...
    about: {
      eyebrow: "About Kamesh Malhotra",
      h2a: "The face of JDLO in India.",
      h2b: "Born here. Built here. Available here.",
      storyP1: "I'm Kamesh Malhotra. 21, from Jammu (J&K). I run JDLO India.",
      storyP2: "Every conversation about an Indian project — from the first WhatsApp message, through the build, to ongoing support — comes through me. In Hindi or English. Whichever you prefer.",
      storyP3: "JP builds the systems. I make sure they get into the right hands and actually work for Indian businesses. Two of us. No agency layers. No middlemen.",
      quote: "I'm not selling websites. I'm selling Indian businesses a way to look and run as serious as they actually are.",
      qualHeader: "What Kamesh Malhotra brings",
      quals: [
        "Custom websites — mobile-first, your branding, no templates",
        "WhatsApp Business integration + auto-reply bots",
        "Razorpay, UPI, and EMI checkout setup (no-cost EMI on most cards)",
        "Instagram catalog sync + reels production for Indian audiences",
        "AI chatbots trained on your business, lead capture, follow-up automation",
        "Facebook + YouTube ad campaigns for Indian audiences",
        "GST-ready invoicing and Indian business compliance setup",
        "Hindi content creation + bilingual delivery (Hindi/English)",
      ],
      contactHeader: "Reach Kamesh Malhotra directly",
  ...
  hi: {
    ...
    proof: {
      ...
      sub: "24 लाइव प्रोजेक्ट्स वेरिफाइड — फैशन ब्रांड्स, सर्विस बिज़नेस, ई-कॉमर्स स्टोर्स, AI टूल्स। किसी भी प्रोजेक्ट पर क्लिक करके पूरी केस स्टडी देखें।",
      items: PROOF_ITEMS,
      seeAll: "सभी 24 लाइव प्रोजेक्ट्स देखें",
    ...
    team: {
      ...
      jpName: "JP — बिल्डर",
      jpDesc: "पूरा सिस्टम खुद बनाता है। 24 लाइव प्रोजेक्ट्स वेरिफाइड। US, Vegas, Hawaii के क्लाइंट्स, अब भारत भी। हर साइट खुद बिल्ड करता है — कोई आउटसोर्सिंग नहीं, कोई टेम्पलेट्स नहीं, कोई एजेंसी ड्रामा नहीं।",
      jpLink: "काम देखें →",
      kameshRole: "JDLO India · डायरेक्टर",
      kameshName: "Kamesh Malhotra",
      kameshTitle: "Director · JDLO India",
      kameshLocation: "जम्मू (J&K), भारत · 21 साल",
      kameshDesc: "जम्मू से JDLO India चलाते हैं। पहले WhatsApp मैसेज से लेकर लॉन्च डे तक हर बातचीत संभालते हैं — हिंदी या अंग्रेज़ी में। हर build के लिए JP से सीधा connection।",
      kameshLangs: "हिंदी (मातृभाषा) · अंग्रेज़ी (फ्लूएंट)",
      kameshEmail: "malhotrakamesh7@gmail.com",
      kameshCta: "Kamesh Malhotra को मैसेज करें",
    },
    roadmap: {
    ...
    about: {
      eyebrow: "Kamesh Malhotra के बारे में",
      h2a: "भारत में JDLO का चेहरा।",
      h2b: "यहीं पैदा हुए। यहीं बने। यहीं उपलब्ध।",
      storyP1: "मैं Kamesh Malhotra हूँ। 21 साल का, जम्मू (J&K) से। JDLO India मैं चलाता हूँ।",
      storyP2: "किसी भी भारतीय प्रोजेक्ट की हर बातचीत — पहले WhatsApp मैसेज से, build के दौरान, ongoing support तक — मुझसे होकर गुज़रती है। हिंदी या अंग्रेज़ी, जो आप चाहें।",
      storyP3: "सिस्टम्स JP बनाते हैं। मैं देखता हूँ कि वो सही हाथों में पहुँचें और भारतीय बिज़नेस के लिए सच में काम करें। हम दो हैं। कोई एजेंसी layer नहीं। कोई बीच में नहीं।",
      ...
      qualHeader: "Kamesh Malhotra क्या लाते हैं",
      quals: [
        "कस्टम वेबसाइट्स — मोबाइल-फर्स्ट, आपकी ब्रांडिंग, कोई टेम्पलेट नहीं",
        "WhatsApp Business इंटीग्रेशन + ऑटो-रिप्लाई बॉट्स",
        "Razorpay, UPI, और EMI चेकआउट सेटअप (ज़्यादातर कार्ड्स पर no-cost EMI)",
        "Instagram कैटलॉग सिंक + भारतीय audiences के लिए reels production",
        "AI चैटबॉट्स आपके बिज़नेस पर ट्रेन्ड, lead capture, फॉलो-अप ऑटोमेशन",
        "भारतीय audiences के लिए Facebook + YouTube ad campaigns",
        "GST-ready invoicing और Indian business compliance setup",
        "हिंदी content creation + bilingual delivery (हिंदी/अंग्रेज़ी)",
      ],
      contactHeader: "Kamesh Malhotra से सीधे संपर्क करें",
      contactWa: "WhatsApp: +91 97975 96601",
      contactEmail: "Email: malhotrakamesh7@gmail.com",
