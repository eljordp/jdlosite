...
export const copy: Record<Lang, CopyShape> = {
  ...
  hg: {
    hero: {
      eyebrow: "JDLO India · Websites + Systems",
      h1a: "Aapka business WhatsApp pe chalta hai.",
      h1b: "Website bhi waisi honi chahiye.",
      desc: "Hum Indian businesses ke liye websites aur systems banate hain — fashion brands, wedding photographers, coaches. WhatsApp-first. Razorpay built-in. Sirf 2 weeks mein live.",
      ctaPrimary: "WhatsApp Kamesh",
      ctaSecondary: "Pricing dekho",
    },
    problem: {
      eyebrow: "Problem",
      h2a: "Aapka kaam mast hai.",
      h2b: "Lekin online aap chhote dikhte ho — jitne aap actually ho usse bhi kam.",
      symptoms: [
        "Customers website link maangte hain. Aap apna Insta bhej dete ho.",
        "Orders WhatsApp mein dher lag jaate hain. Aadhe chat mein kho jaate hain.",
        "Aap utna hi charge kar rahe ho jitna koi bina portfolio site wala karta hai.",
        "Bade brands aapke customers le ja rahe hain kyunki woh zyada legit dikhte hain.",
        "Roz ghante chale jaate hain wahi 5 sawaalon ke jawab dene mein.",
      ],
    },
    niches: {
      eyebrow: "Hum Kiske Liye Banate Hain",
      h2: "Teen tarah ke businesses.",
      sub: "Hum koi generic web shop nahi hain. Hum un businesses ke liye banate hain jinhe humne India mein fast scale karte dekha hai. Agar aap inme se ek ho, toh hume already pata hai aapko kya chahiye.",
      items: [
        {
          num: "01",
          title: "Fashion & D2C Brands",
          sub: "WhatsApp + Insta pe selling",
          desc: "Ek clean catalog site jo aapke Instagram se pull karti hai, customers ko bina DM kiye browse karne deti hai, aur Razorpay se checkout ya direct WhatsApp pe le jaati hai. Jaisi brand aap actually ho, waisi dikho.",
        },
        {
          num: "02",
          title: "Wedding Photographers & Planners",
          sub: "Premium clients ke liye premium portfolios",
          desc: "Ek portfolio site jo families ko bina bargain kiye full rate dilwati hai. Galleries, packages, inquiry form, WhatsApp booking. Aisi site jo chai pe share hoti hai aur weddings book karwati hai.",
        },
        {
          num: "03",
          title: "Coaches & Educators",
          sub: "IELTS, fitness, business, dance",
          desc: "Landing page + course checkout jo aapke liye selling karta hai. Razorpay subscriptions, EMI option, automated WhatsApp follow-up. Payments ke peeche bhagna band — system karega yeh kaam.",
        },
      ],
    },
    deliverables: {
      eyebrow: "Aapko Kya Milega",
      h2a: "6 cheezein.",
      h2b: "Ek system.",
      items: [
        { label: "Custom website", desc: "Aapke business ke liye banayi gayi, template nahi. Mobile-first kyunki aapke customers wahin hain." },
        { label: "Razorpay + UPI checkout", desc: "India ke kisi bhi corner se payments le sakte ho. Cards, UPI, net banking, EMI — sab built in." },
        { label: "WhatsApp integration", desc: "Har page pe one-tap WhatsApp button. Auto-replies, order forms, customer chat — jaise aap chaaho." },
        { label: "Instagram catalog sync", desc: "Aapke latest posts aur products site pe auto-pull ho jaate hain. Insta update karo, site bhi update ho jaayegi." },
        { label: "Lead inbox + dashboard", desc: "Har inquiry, order, booking ek jagah pe. Searchable. WhatsApp mein customer kabhi nahi khoyega." },
        { label: "Hindi ya English (ya dono)", desc: "Aapke audience ke liye banayi. Hindi, English, ya bilingual — aapki marzi. Language ka kaam Kamesh sambhalta hai." },
      ],
    },
    proof: {
      eyebrow: "Receipts",
      h2a: "Yeh kaam pehle bhi kiya hai.",
      h2b: "Real businesses ke liye, real numbers ke saath.",
      sub: "30+ projects ship kiye — fashion brands, service businesses, e-commerce stores, AI tools. Kisi bhi project pe click karke full case study dekho.",
      items: PROOF_ITEMS,
      seeAll: "Saare 30+ projects dekho",
      caseStudy: "Case study dekho →",
    },
    pricing: {
      eyebrow: "Pricing",
      h2a: "Teen tiers.",
      h2b: "Apne business ke hisaab se choose karo.",
      sub: "Saari prices INR mein. Payment plans available — 50% start mein, 50% delivery pe. Razorpay se EMI option. Koi hidden fees nahi, koi surprise bills nahi.",
      ...
      tiers: [
        {
          ...
          usd: "≈ $1,000",
          sub: "one-time",
          desc: "Single-page site, WhatsApp + Razorpay integration, mobile-first design. 7 din mein live.",
          fit: "Best for: chhote D2C brands, solo coaches, individual photographers",
          monthly: "+ ₹4,000/mo hosting & care",
          cta: "Kamesh se baat karo",
        },
        {
          name: "Studio",
          inr: "₹2,50,000",
          usd: "≈ $3,000",
          sub: "one-time",
          desc: "Multi-page site, full catalog, lead inbox, Instagram sync, automated WhatsApp follow-up. 14 din mein live.",
          fit: "Best for: established fashion brands, wedding studios, coaching businesses",
          monthly: "+ ₹8,000/mo hosting & care",
          cta: "Kamesh se baat karo",
          featured: true,
        },
        {
          ...
          usd: "≈ $6,000",
          sub: "one-time",
          desc: "Studio mein sab kuch + custom features, AI follow-up agent, multi-language (Hindi + English), priority support.",
          fit: "Best for: ₹10L+/mo karne wale brands jo proper dikhna chahte hain",
          monthly: "+ ₹15,000/mo hosting & care",
          cta: "Kamesh se baat karo",
        },
      ],
      note: "Pata nahi konsa tier? WhatsApp Kamesh — woh aapse 5 sawaal poochega aur seedha bata dega ki konsa fit hai.",
    },
    process: {
      eyebrow: "Kaise Kaam Karta Hai",
      h2a: "Teen steps.",
      h2b: "Koi beech mein nahi.",
      steps: [
        { num: "01", title: "WhatsApp Kamesh", desc: "Ek message bhejo. Woh aapke business, customers, aur requirements ke baare mein poochega. 10 minutes, Hindi ya English mein. Koi sales pitch nahi." },
        { num: "02", title: "50% pay karo, hum start karte hain", desc: "Razorpay ya UPI se 50% deke apna slot lock karo. Hum same day build start karte hain. Har few days WhatsApp pe progress updates milte hain." },
        { num: "03", title: "Site live ho jaati hai", desc: "Tier ke hisaab se 7 se 14 din. Launch ke pehle aap site dekhte ho, baad mein nahi. Delivery pe baaki 50% pay karo. Site aapki, hamesha ke liye." },
      ],
    },
    team: {
      eyebrow: "Team",
      h2a: "JDLO ne banaya.",
      h2b: "Kamesh ne India mein chalaaya.",
      jpRole: "JDLO · Founder",
      jpName: "JP — Builder",
      jpDesc: "Pura system khud banata hai. 30+ projects ship kiye. US, Vegas, Hawaii ke clients, ab India bhi. Har site khud build karta hai — koi outsourcing nahi, koi templates nahi, koi agency drama nahi.",
      jpLink: "Kaam dekho →",
      kameshRole: "JDLO India · Director",
      kameshName: "Kamesh Malhotra — Aapka Point of Contact",
      kameshDesc: "India mein based. Aapki language bolta hai. Pehle WhatsApp message se launch day tak har baat sambhalta hai. Indian market ko inside out jaanta hai — kya kaam karta hai, kya nahi, aur aap actually kya charge kar sakte ho.",
      kameshCta: "Kamesh ko message karo",
    },
    faq: {
      eyebrow: "FAQ",
      h2: "Log kya poochte hain.",
      items: [
        { q: "₹85,000 kyun jab ₹10,000 mein website mil jaati hai?", a: "Kyunki woh ₹10,000 ki site Wix template hai jo 6 mahine mein break ho jaati hai aur aapko har dusre small business jaisa dikhati hai. Hum custom banate hain — aapki branding, aapka offer, aapka customer flow. Razorpay, WhatsApp, Instagram sync, lead inbox, sab integrated. Yeh website nahi, system hai." },
        { q: "Payments kaise kaam karte hain? Razorpay ya international?", a: "Saare payments humein Razorpay ya UPI se INR mein aate hain. International banking ki zarurat nahi, currency conversion ka tension nahi. Kamesh sab collection sambhalta hai. Aap rupees mein pay karte ho, jaise koi bhi Indian business." },
        { q: "EMI mein pay kar sakta hoon?", a: "Haan. Razorpay zyaada credit cards pe no-cost EMI support karta hai (3-12 months). Studio aur Brand tiers ke liye 50/50 plan bhi hai — aadha start mein, aadha delivery pe." },
        { q: "Site Hindi mein hogi ya English?", a: "Aapki marzi. Zyaada clients bilingual karte hain — credibility ke liye English, warmth ke liye Hindi. Brand tier mein regional languages bhi (Tamil, Telugu, Marathi, etc.)." },
        { q: "Jo aap banate ho woh sab mera hota hai?", a: "Haan. Source code, domain, customer data, sab. Hamare account ke peeche kuch lock nahi. Launch ke baad agar aap chod ke jaana chaaho, pura system aapka rahega. Bas hum nahi honge fix karne ke liye jab kuch toot jaaye." },
        { q: "Mujhe sirf simple WhatsApp catalog chahiye?", a: "Toh Starter le lo — yahi ke liye banaya hai. WhatsApp catalog, basic site, payments. ₹85K mein 7 din mein live. Zyaada fashion D2C brands yahin se start karte hain." },
        { q: "India ke liye SEO sambhal sakte ho?", a: "Basic SEO har tier mein included — Google My Business setup, meta tags, sitemap. Deep SEO (content, backlinks, ranking work) alag engagement hai jo launch ke baad scope kar sakte hain." },
      ],
    },
    finalCta: {
      eyebrow: "Start karne ke liye taiyaar",
      h2a: "Ek WhatsApp message.",
      h2b: "Bas wahin se shuru hota hai.",
      desc: "Kamesh ko apne business ke baare mein batao. Woh seedha bata dega ki hum help kar sakte hain ya nahi, konsa tier fit hai, aur kitni jaldi ship kar sakte hain. Koi sales call nahi, koi pitch deck nahi.",
      ctaPrimary: "Abhi WhatsApp Kamesh",
      ctaSecondary: "JDLO ko Instagram pe dekho",
      note: "Kamesh 2 ghante mein reply karta hai · 9am–11pm IST",
    },
  },
      ...
      tiers: [
        {
          ...
          usd: "≈ $1,000",
          sub: "एक-बार",
          desc: "सिंगल-पेज साइट, WhatsApp + Razorpay इंटीग्रेशन, मोबाइल-फर्स्ट डिज़ाइन। 7 दिनों में लाइव।",
          fit: "Best for: छोटे D2C ब्रांड्स, सोलो कोच, इंडिविजुअल फोटोग्राफर",
