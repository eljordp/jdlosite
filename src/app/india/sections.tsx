...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 bg-[#25D366] text-black font-semibold tracking-tight px-6 py-3 rounded-full text-[14px] hover:bg-[#1ebe57] transition-colors duration-200 ${
        !noPulse ? "wa-pulse" : ""
      } ${className}`}
    >
