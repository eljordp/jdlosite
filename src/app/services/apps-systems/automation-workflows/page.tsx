        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <RevealOnScroll>
            <div className="max-w-[600px]">
              ...
              <p className="text-text-secondary text-[16px] leading-relaxed mb-8">I map out every repetitive task in your business, then build systems that handle them automatically. Data entry, follow-ups, scheduling, invoicing, reporting. Gone. Velvet runs 500+ guest list bookings a week with zero human input. Vacaville Appliance books 40+ service appointments a month overnight. The right system pays for itself fast.</p>
