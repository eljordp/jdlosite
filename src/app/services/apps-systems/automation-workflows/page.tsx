        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <RevealOnScroll>
            <div className="max-w-[600px]">
              ...
              <p className="text-text-secondary text-[16px] leading-relaxed mb-8">I map repetitive work, then connect the parts that are safe and useful to automate: data entry, follow-up, scheduling, invoicing, and reporting. The goal is not automation theater. It is fewer dropped leads, cleaner handoffs, and more time for work that creates revenue.</p>
