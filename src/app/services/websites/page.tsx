        ...
        <div className="max-w-[900px]">
          <RevealOnScroll>
            <h2 className="font-display text-[clamp(2.4rem,5.5vw,5rem)] leading-[0.95] tracking-[-0.03em] mb-8">
              Websites start at $3,000.
            </h2>
          </RevealOnScroll>

          <RevealOnScroll delay={1}>
            <p className="text-text-secondary text-lg md:text-xl leading-relaxed max-w-[560px] mb-16">
              Most projects deliver in under 2 weeks. Payment plans available
              &mdash; put down a deposit, pay the rest on delivery.
            </p>
          </RevealOnScroll>
