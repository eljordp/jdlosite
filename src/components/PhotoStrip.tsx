...
const photos = [
  ...
  { src: `${BASE}070611cda_image.png`, alt: 'Car Vibes', story: 'The car is where I do some of my best thinking. Music right, no interruptions, brain just runs. Half my business ideas were born somewhere between exits on the freeway.' },
